...
public class TestaInsercaoComParametro {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			PreparedStatement stm = connection.prepareStatement("INSERT INTO PRODUTO "
					+ "(NOME,DESCRICAO) VALUES (?,?)",Statement.RETURN_GENERATED_KEYS);
			
			adicionarVariavel("SmartTV", "45 polegas", stm);
	...
	(String nome, String descricao, PreparedStatement stm) throws SQLException {
