...
public class ProdutoDao {
	...
	public List<Produto> buscarPorNomeDaCategoria(String nome) {
		return em.createNamedQuery("Produto.produtosPorCategoria", Produto.class).setParameter(1, nome).getResultList();
	}
	...
	public List<Produto> buscarPorParamentrosComCriteria(String nome, 
